                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Nama Dokter</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="jabatandokter" class="form-label">Jabatan</label>
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Pilih Jabatan</option>
                                        <option value="1">Dokter Umum</option>
                                        <option value="2">Dokter Paruh Waktu</option>
                                        <option value="3">Dokter Spesialis</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="hari" class="form-label">Jabatan</label>
                                    <select class="form-select" aria-label="Default select example">
                                        ...
                                        <option value="8">Setiap Hari</option>
                                        <option value="9">Senin - Jum'at</option>
                                        <option value="10">Lainnya</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Waktu</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="hari" class="form-label">Jabatan</label>
