                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">HP IGD</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Call Center</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Hp dr Spesialis Interna</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Hp dr Spesialis Bedah</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="ketgambar" class="form-label">Hp dr Spesialis Obgyn</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
                                <div class="mb-3">
                                    <label for="ketgambar" class="form-label">Hp dr Spesialis Anak</label>
                                    <input type="" class="form-control" id="" aria-describedby="">
                                </div>
