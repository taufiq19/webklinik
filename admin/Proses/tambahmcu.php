                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    <label for="namagambar" class="form-label">Jenis Paket</label>
                                ...
                                <div class="mb-3">
                                    <label for="jabatandokter" class="form-label">Pemeriksaan</label>
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Pilih Pemeriksaan</option>
                                        <option value="1">Pemeriksaan GDS</option>
                                        <option value="2">Pemeriksaan Urin</option>
                                    </select>
                                </div>
