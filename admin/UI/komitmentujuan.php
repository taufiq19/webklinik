            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Komitmen & Tujuan</li>
                    </ol>

                    <h2 class="accordion-header" id="flush-headingOne">
                        <a href="../Proses/tambahkomitmentujuan.php"><button type="button" class="btn btn-primary btn-lg mb-4"><i class="bi bi-pen"></i> Ubah Data</button></a>
                    </h2>

                    <div class="card shadow-sm mb-4">
                        <div class="card-header">
                            Komitmen & Tujuan Klinik
                        </div>
                        <div class="card-body">
