                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h2 class="accordion-header" id="flush-headingOne">
                            <a href="../Proses/tambahalurpelayanan.php"><button type="button" class="btn btn-primary btn-lg mb-4"><i class="bi bi-plus-circle"></i> Tambah Data</button></a>
                        </h2>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Pendaftaran Pasien BPJS</td>
                                            <td>---</td>
                                            <td>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Pariatur, similique.</td>
                                            <td>
