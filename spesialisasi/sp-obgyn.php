<?php
$ambil_data = $host->query("SELECT * FROM jadwal_dokter JOIN dokter ON jadwal_dokter.id_dokter = dokter.id_dokter WHERE jabatan = 'Dokter Spesialis Obgyn' order by id_jadwal DESC;");
$ambil_data2 = $host->query("SELECT * FROM jadwal_dokter JOIN dokter ON jadwal_dokter.id_dokter = dokter.id_dokter WHERE jabatan = 'Dokter Spesialis Obgyn' order by id_jadwal DESC;");

?>
<!-- Banner Spesialis Obgyn -->
<section class="banner-spesialis">
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item c-i active">
                <img src="image/banner/Obgyn.jpg" class="d-block w-100" alt="Banner Spesialisasi">
    ...
    <div class="container p-4">
        <div class="row py-5 txt-konsul-dokter">
            <div class="col-lg-8 col-sm-12 p-2 mb-2">
                <h3 class="fw-semibold text-capitalize mb-3">Konsultasi Dokter Spesialis Obgyn</h3>
