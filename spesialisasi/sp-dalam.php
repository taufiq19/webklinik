<?php
$ambil_data = $host->query("SELECT * FROM jadwal_dokter JOIN dokter ON jadwal_dokter.id_dokter = dokter.id_dokter WHERE jabatan = 'Dokter Spesialis Penyakit Dalam' order by id_jadwal DESC;");
$ambil_data2 = $host->query("SELECT * FROM jadwal_dokter JOIN dokter ON jadwal_dokter.id_dokter = dokter.id_dokter WHERE jabatan = 'Dokter Spesialis Penyakit Dalam' order by id_jadwal DESC;");

?>
<!-- Banner Spesialis Penyakit Dalam -->
<section class="banner-spesialis">
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item c-i active">
                <img src="image/banner/spesialis-pd.jpg" class="d-block w-100" alt="Banner Spesialisasi">
                <div class="carousel-caption d-flex justify-content-center">
                    <div class="bks-spesialis">
                        <div class="box-s-pd py-4 px-4 lh-base bg-gradient rounded-3 d-none d-sm-block">
                            <h1>Klinik</h1>
                            <h2 class="mb-4">Penyakit Dalam</h2>
...
<!-- Akhir Banner Spesialis Penyakit Dalam -->
    ...
    <div class="container p-4">
        <div class="row py-5 txt-konsul-dokter">
            <div class="col-lg-8 col-sm-12 p-2 mb-2">
                <h3 class="fw-semibold text-capitalize mb-3">Konsultasi Dokter Spesialis Penyakit Dalam</h3>
